# This Makefile is for the WWW::Mechanize::AutoPager extension to perl.
#
...
#     ABSTRACT => q[Automatic Pagination using AutoPagerize]
#     AUTHOR => q[Tatsuhiko Miyagawa <miyagawa@bulknews.net>]
#     DIR => []
#     DISTNAME => q[WWW-Mechanize-AutoPager]
#     NAME => q[WWW::Mechanize::AutoPager]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { HTML::AutoPagerize=>q[0], Test::More=>q[0], WWW::Mechanize::DecodedContent=>q[0], WWW::Mechanize=>q[0] }
#     VERSION => q[0.01]
...
NAME_SYM = WWW_Mechanize_AutoPager
VERSION = 0.01
...
FULLEXT = WWW/Mechanize/AutoPager
BASEEXT = AutoPager
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/WWW/Mechanize/AutoPager.pm
...
TO_INST_PM = lib/WWW/Mechanize/AutoPager.pm

PM_TO_BLIB = lib/WWW/Mechanize/AutoPager.pm \
...
DISTNAME = WWW-Mechanize-AutoPager
DISTVNAME = WWW-Mechanize-AutoPager-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/WWW/Mechanize/AutoPager.pm $(INST_MAN3DIR)/WWW::Mechanize::AutoPager.$(MAN3EXT) 
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Automatic Pagination using AutoPagerize</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Tatsuhiko Miyagawa &lt;miyagawa@bulknews.net&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="HTML-AutoPagerize" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="WWW-Mechanize-DecodedContent" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/WWW/Mechanize/AutoPager.pm blib/lib/WWW/Mechanize/AutoPager.pm 
